...
def addsudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in SUPPORT_USERS:
        rt += "Requested Devils Hunter Union to promote a Support user to Sudo."
        SUPPORT_USERS.remove(user_id)

    if user_id in WHITELIST_USERS:
        rt += "Requested Devils Hunter Union to promote a Whitelist user to Sudo."
...
def addsupport(
    ...
    if user_id in SUDO_USERS:
        rt += "Requested Devils Hunter Union to demote this Sudo to Support"
    ...
    if user_id in WHITELIST_USERS:
        rt += "Requested Devils Hunter Union to promote this Whitelist user to Support"
        WHITELIST_USERS.remove(user_id)
...
def removesudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in SUDO_USERS:
        message.reply_text("Requested Devils Hunter Union to demote this user to Civilian")
        SUDO_USERS.remove(user_id)
...
nations = """ Makima has bot access levels we call as *"Nation Levels"*
\n*Devils Hunter Union* - Devs who can access the bots server and can execute, edit, modify bot code. Can also manage other Nations
\n*God* - Only one exists, bot owner.
Owner has complete bot access, including bot adminship in chats Makima is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Makima.
\n*Sakuras* - Have access go globally ban users across Makima.
...
\n*Disclaimer*: The Nation levels in Makima are there for troubleshooting, support, banning potential scammers.
Report abuse or ask us more on these at [Devils Hunter Union](https://t.me/pbshinigami).
"""
...
def devlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Devils Hunter Union Members :</b>\n"
