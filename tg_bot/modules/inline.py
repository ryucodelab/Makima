...
def inlinequery(update: Update, _) -> None:
    ...
    if (f := query.split(" ", 1)[0]) in inline_funcs:
        ...
        inline_help_dicts = [
            ...
            #},
            {
                "title": "Account info on Makima",
                "description": "Look up a Telegram account in Makima database",
                "message_text": "Click the button below to look up a person in Makima database using their Telegram ID",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".info ",
            },
            {
                "title": "About",
                "description": "Know about Makima",
                "message_text": "Click the button below to get to know about Makima.",
                "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
                "keyboard": ".about ",
            },
            {
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += "\\n\\nThis Person is a part of Devils Hunter Union"
        nation_level_present = True
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    """
    results: list = []
    kb = InlineKeyboardMarkup([[InlineKeyboardButton(text="Support", url="https://t.me/pbshinigami"), InlineKeyboardButton(text="Channel", url="https://t.me/devilhuntershub"), InlineKeyboardButton(text='Ping', callback_data='pingCB')], [InlineKeyboardButton(text="GitHub", url="https://github.com/ryucodelab/Makima",)]])
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Makima (@{context.bot.username})",
